(window.webpackJsonp=window.webpackJsonp||[]).push([[3],{43:function(e,t,s){"use strict";s.r(t);var r=s(0),o=s(1);let i=class PersonService{getPersons(){return fetch("https://jsonplaceholder.typicode.com/users").then(e=>e.json())}};i=Object(r.__decorate)([Object(o.Injectable)()],i);let a=class PersonsList{constructor(e,t){this.personSrvc=e,this.router=t,this.data=[],this.persondetails={},console.log("current route ",this.router.getCurrentRoute())}mount(){this.personSrvc.getPersons().then(e=>{this.data=e,this.update()})}alertName(e){this.persondetails=e,this.update()}render(){return o.html`
		...
		`}};a=Object(r.__decorate)([Object(o.Component)({selector:"persons-list",styleUrl:"persons-list.scss",useShadow:!1}),Object(r.__metadata)("design:paramtypes",[i,o.Router])],a);let n=class PersonDetails{constructor(){this.userDetails={}}render(){return console.log("selected: user",this.userDetails),this.userDetails.name?o.html`
