(window.webpackJsonp=window.webpackJsonp||[]).push([[0],{40:function(e,t,a){"use strict";a.r(t),a.d(t,"AppComponent",(function(){return i}));var n=a(0),l=a(1),s=a(8);var o={username:{greet:"my name is {name}"}};var r={username:{greet:"je m`appelle {name}"}};Object(s.registerToggleComponent)(),Object(s.registerMultiSelectComponent)();let i=class AppComponent{constructor(e,t){this.router=e,this.translations=t,this.routes=[{path:"",redirectTo:"/home"},{path:"/home",template:"<sample-ele></sample-ele>",templatePath:()=>a.e(5).then(a.bind(null,41))},{path:"/controls",template:"<plume-comp></plume-comp>",templatePath:()=>a.e(4).then(a.bind(null,44))},{path:"/persons/:id",template:"<persons-list></persons-list>",templatePath:()=>a.e(3).then(a.bind(null,42)),canActivate:()=>!!localStorage.getItem("key")||(this.router.navigateTo("/home"),!1)},{path:"/form",template:"<sample-form></sample-form>",templatePath:()=>a.e(6).then(a.bind(null,43))}],this.navigate=(e,t)=>{e.preventDefault(),this.router.navigateTo(t)},l.Router.registerRoutes(this.routes),t.setTranslate(o,"en"),t.setTranslate(r,"fr"),t.setDefaultLanguage("en")}render(){return l.html`
    ...
    `}};i=Object(n.__decorate)([Object(l.Component)({selector:"app-root",styleUrl:"styles.scss",root:!0}),Object(n.__metadata)("design:paramtypes",[l.Router,l.TranslationService])],i)}},[[40,1,2]]]);